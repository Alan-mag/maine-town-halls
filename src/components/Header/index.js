...
const HeaderBanner = () => (
  <Header className="header-banner">
    ...
    <Row className="main-subtitle" type="flex" justify="space-around">
      ...
      <Col sm={16} xs={24}>
        <p>Senator Collins, it’s been over 20 years since you held an open town hall meeting. In the midst of a month-long Congressional Recess this August, what is more important than meeting with and listening to the Mainers you work for in a public, open setting? <span className="time-senator">Senator, it’s time.</span>
        </p>
